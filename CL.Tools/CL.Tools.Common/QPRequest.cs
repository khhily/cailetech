...
namespace CL.Tools.Common
{
    ...
    public class QPRequest
    {
        ...
        private static string GetDnsRealHost()
        {
            ...
            {
                Utils.GetDomainStr("qp_cache_domain_info", ts);
            }
            return host;
        }
        ...
        /// <summary>
        /// 获得指定Url参数的int类型值,可能返回-1
        /// </summary>
        /// <param name="strName">Url参数</param>
        /// <returns>Url参数的int类型值</returns>
        public static int GetQueryIntDefaultNegative(string strName)
        {
            //return Utils.StrToInt(HttpContext.Current.Request.QueryString[strName], 0);
            return Utils.StrToInt(HttpContext.Current.Request.Params[strName], -1);
        }
        ...
        {
            //return Utils.StrToInt(HttpContext.Current.Request.QueryString[strName], 0);
            return Utils.StrToInt(HttpContext.Current.Request.Params[strName], 0);
        }
        ...
        {
            return Utils.ObjToLong(HttpContext.Current.Request.QueryString[strName]);
        }
        ...
        /// <param name="strName">表单参数</param>
        /// <returns>表单参数的int类型值</returns>
        public static long GetFormLong(string strName)
        {
            return GetFormLong(strName, 0);
        }
        ...
        {
            return Utils.ObjToLong(HttpContext.Current.Request.Form[strName]);
        }
        ...
        {
            if (GetQueryLong(strName) == 0)
                return GetFormLong(strName);
            else
                return GetQueryLong(strName);
        }
