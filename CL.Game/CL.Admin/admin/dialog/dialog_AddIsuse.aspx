<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_AddIsuse.aspx.cs" Inherits="CL.Admin.admin.dialog.dialog_AddIsuse" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function execAddIsuse() {
            ...
            //$.post("../../tools/admin_ajax.ashx?action=create_isuse", para, function (data) {
            //    var jsondata = JSON.parse(data);
            //    if (jsondata.status == 0)
            //        api.close("创建期号成功").remove();
            //    else{
            //        api.close("创建期号失败").remove();
            //    }
            //});
        }
    </script>
      ...
      <div class="dl-attach-box">
        <dl>
          ...
          <dl>
              <dt></dt>
              <dd>
                  高频性彩票，您只需要选择增加的天数，系统会自动在指定的天数内，增加每天的所有期号
              </dd>
          </dl>
      </div>
    </div>
