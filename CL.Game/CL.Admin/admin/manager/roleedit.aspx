<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="roleedit.aspx.cs" Inherits="CL.Admin.admin.manager.roleedit" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <!--导航栏-->
        <div class="location">
            <a href="rolelist.aspx" class="back"><i></i><span>返回列表页</span></a>
            <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <a href="managerlist.aspx"><span>管理员</span></a>
            <i class="arrow"></i>
            <a href="rolelist.aspx"><span>管理角色</span></a>
            <i class="arrow"></i>
            <span>编辑角色</span>
        </div>
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>角色名称</dt>
                <dd>
                    <asp:TextBox ID="txtRoleName" runat="server" CssClass="input normal" datatype="*1-50" sucmsg=" " ajaxurl="../../tools/admin_ajax.ashx?action=rosle_validate"></asp:TextBox>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        <td style="white-space: nowrap; word-break: break-all; overflow: hidden;">
                                            ...
                                            <asp:HiddenField ID="hidActionType" Value='<%#Eval("ActionType") %>' runat="server" />
        ...
        <script>
            function selectall() {
                var selstr = $("#ddlRoleType").find("option:selected").attr("value");
                if (selstr == 1) {
                    $("input[type='checkbox']").prop("checked", true);
                }
                else if (selstr == null || selstr == '') {
