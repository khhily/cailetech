<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="managerlog.aspx.cs" Inherits="CL.Admin.admin.manager.managerlog" %>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      <td align="center">
        <a href="managerlog.aspx?keywords=<%# Eval("UserName") %>"><%# Eval("UserName")%></a>
      </td>
      <td align="center">
        <a href="managerlog.aspx?keywords=<%# Eval("ActionType") %>"><%# Eval("ActionType") %></a>
      </td>
      <td><%# Eval("Remark") %></td>
      <td><%# Eval("UserIP") %></td>
      <td><%# Eval("AddTime") %></td>
