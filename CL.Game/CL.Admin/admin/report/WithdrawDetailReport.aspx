<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WithdrawDetailReport.aspx.cs" Inherits="CL.Admin.admin.report.WithdrawDetailReport" %>
            ...
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        ...
                        <asp:TextBox ID="txtReservedPhone" runat="server" CssClass="input txt" placeholder="输入预留手机" />
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center"><%#Eval("ReservedPhone") %></td>
                        ...
                        <td align="center"><%#ConvertPayOutStatus(Eval("PayOutStatus")) %></td>
                        <td align="center"><%#Eval("CreateTime") %></td>
                        <td align="center"><%#Eval("OperTime") %></td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
