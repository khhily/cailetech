<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buylotreport.aspx.cs" Inherits="CL.Admin.admin.report.finance.buylotreport" %>
            ...
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        ...
                        <div class="rule-single-select">
                            <asp:DropDownList ID="ddlSchemeStatus" runat="server">
                                <asp:ListItem Value="-1">全部状态</asp:ListItem>
                                <asp:ListItem Value="0">0待付款</asp:ListItem>
                                ...
                                <asp:ListItem Value="18">未中奖</asp:ListItem>
                                <asp:ListItem Value="19">追号中</asp:ListItem>
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center"><%# SetBuyType(Eval("BuyType"))%></td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
