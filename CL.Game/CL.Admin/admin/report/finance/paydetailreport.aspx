<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="paydetailreport.aspx.cs" Inherits="CL.Admin.admin.report.finance.paydetailreport" %>
            ...
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        ...
                        平台订单编号:<asp:TextBox ID="txtOrderNo" runat="server" CssClass="input" />
                        第三方订单编号:<asp:TextBox ID="txtRechargeNo" runat="server" CssClass="input" />
                        充值方式:<asp:TextBox ID="txtPayType" runat="server" CssClass="input" />
                    </div>
                    <div class="l-list" style="margin-top: 10px;">
