...
{
    public partial class outticketreport : UI.AdminPage
    {
        protected static long TotalAmount = 0;
        protected static long TotalWin = 0;
        ...
        private void BindData(int Page = 0)
        {
            ...
            int PrintOutType = Convert.ToInt32(ddlPrintOutType.SelectedValue);
            ...
            int TotalCount = 0;
            var Entitys = new SchemeETicketsBLL().QueryOutTicketReport(StartTime, EndTime, LotteryCode, PrintOutType, SchemeNumber, PageIndex, PageSize, ref TotalAmount, ref TotalWin, ref TotalCount);
            this.rptList.DataSource = Entitys;
            this.rptList.DataBind();
            string pageUrl = Utils.CombUrlTxt("outticketreport.aspx", "PageIndex={0}", "__id__");
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    PageIndex = _pagesize;
                    BindData();
                    Utils.WriteCookie("outticketreport_page_size", "QPcmsPage", _pagesize.ToString(), 14400);
                    Response.Redirect(Utils.CombUrlTxt("outticketreport.aspx", "PageIndex={0}", _pagesize.ToString()));
                }
            }
        }
        /// <summary>
        ...
        /// <returns></returns>
        protected string SetStatus(object obj, object obj1)
        {
            ...
            switch (Convert.ToInt32(obj))
            {
                ...
                case 14:
                    long WinMoney = (Convert.ToInt64(obj1) / 100);
                    if (WinMoney > 0)
                        rec = "中奖";
                    else
                        rec = "未中奖";
