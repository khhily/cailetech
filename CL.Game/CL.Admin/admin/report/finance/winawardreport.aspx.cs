...
{
    public partial class winawardreport : UI.AdminPage
    {
        ...
        private void BindData(int Page = 0)
        {
            ...
            int TotalCount = 0;
            var Entitys = new SchemesWinBLL().QueryWinAwardReport(StartTime, EndTime, UserCode, UserName, Mobile, LotteryCode, SchemeNumber, PageIndex, PageSize, ref TotalAmount,ref TotalWin, ref TotalCount);
