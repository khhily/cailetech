$(function () {
    ...
    $.fn.InitUploader = function (b) {
        var fun = function (parentObj) {
            ...
            //初始化属性
            if (!parentObj.siblings(".upload-action").val())
                p.sendurl += "?action=uploadfile";
            else
                p.sendurl += "?action=" + parentObj.siblings(".upload-action").val();
            ...
            uploader.on('fileQueued', function (file) {
                //把旧的文件地址传过去
                uploader.options.formData.action = parentObj.siblings('.upload-action').val();
