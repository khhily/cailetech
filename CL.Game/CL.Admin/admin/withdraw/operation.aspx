<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="operation.aspx.cs" Inherits="CL.Admin.admin.withdraw.operation" %>
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center">
                            <asp:LinkButton ID="btn_Pay" OnCommand="btn_pay_Command" runat="server" CommandName="payout" CommandArgument='<%#Eval("PayOutID")%>'>提现</asp:LinkButton>
            ...
            $(this).click(function () {
                var winDialog = top.dialog({
                    ...
                    ok: function () {
                        ...
                        //发送AJAX请求
                        sendAjaxUrl(winDialog, postData, "../../tools/admin_ajax.ashx?action=withdraw&IsRefuse=4");
                        return false;
                    },
                    cancelValue: '取消',
                    cancel: function () { }
